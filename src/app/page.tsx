...
const apikey: any= process.env.IMAGE_EDIT_APIKEY
...
const generateImage = async()=>{
  ...
  return (
    <main className={styles.main}>
      ...
      <h1>AI-Powered Image <span> Editor </span></h1>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
        ...
        {generatedImage && <a className={styles.downloadbtn} download={true} href={generatedImage} target="_blank">Download Image</a> }
      </div>
      <input type="file"
      id="fileinput"
      accept="image/*"
      ...
      <button className={styles.selectImage} onClick={()=> document.getElementById('fileinput')?.click()}>
        ...
        {
          currentImage && <div className={styles.promptContainer}>
            <input type="text" value={description} onChange={handleChange} placeholder="Describe your image"
             />
             <button onClick={generateImage}>Try it</button>
          </div>
        }
